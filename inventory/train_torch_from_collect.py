...
def get_manual_item_name(item_id):
    ...
    tmp_map = {
        '@charm_r0_p9': 'Gold Chip',
        '@charm_r0_p12': 'Error Coin',
        '@charm_r0_p18': 'Dossoles Big Lottery',
        '@charm_r1_p15': '标志物 - 20/15代金券',
        '@charm_r2_p30': '标志物 - 40/30代金券',
        '@charm_r3_p45': 'Scharzhof Professional Coating Device',
        '@charm_r3_p100': 'Court Emeraldia Premium',
    }
